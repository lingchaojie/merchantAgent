...
func demoFixtures(tenant string) []sync.Tuple {
	...
	return []sync.Tuple{
		...
		{User: "user:u_sales1", Relation: "owner", Object: "business_record:" + o("order/ORD-1001")},
		{User: "department:" + o("d_sales"), Relation: "owner_dept", Object: "business_record:" + o("order/ORD-1001")},
		{User: "department:" + o("d_prod") + "#member", Relation: "operator", Object: "business_record:" + o("order/ORD-1001")},
